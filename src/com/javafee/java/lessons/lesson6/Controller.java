...
import com.javafee.java.lessons.lesson6.backend.Restaurant;
import com.javafee.java.lessons.lesson6.frontend.View;
...
public class Controller {
    ...
    private void performActionForAdd() {
        restaurant.addToMenu(view.getInputString("Podaj nazwę dania (powinna być unikalna): "), view.getInputDouble("Podaj cene dania: ")); //TODO: zamiast null system powinien wczytać od użytkownika cenę dania
